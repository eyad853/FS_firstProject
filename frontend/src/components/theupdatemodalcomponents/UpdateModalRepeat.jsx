...
const UpdateModalRepeat = ({setIsRepeatOpen  , setUpdatedRepeat}) => {

  const selectDaily = ()=>{
    setUpdatedRepeat("daily")
  }

  const selectEveryWeek = ()=>{
    setUpdatedRepeat("every week")
  }

  const selectEveryMonth = ()=>{
    setUpdatedRepeat('every Month')
  }
  return (
    <div>
...
export default UpdateModalRepeat